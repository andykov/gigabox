...
$(document).ready(function () {
    ...
    // проверка, если cookie установлена - не показываем, если cookie не установлена - показываем
    var displayStock = getCookie("display_stock");
    if (displayStock != "no") {
        $(document).mouseleave(function(e){
            ...
            if (e.clientY < 0) {
                    ...
                    $.fancybox.open({
                        ...
                        opts : {
                            ...
                            afterClose: function( instance, current ) {
                                console.log( 'done CLOSW!' );
                                console.log($(current.src).remove());
                            }
                        }
                    });
                }
                ...
                document.cookie = "display_stock=no; path=/; expires=" + date.toUTCString();
            }
        });
    }
